    ...
    <PageLayout>
      <div className="flex flex-col items-center justify-center min-h-[60vh] animate-fade-in">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 text-brand-gray-900">
            Hello Stranger, Welcome to<br className="md:hidden" />
            <span className="text-brand-primary"> Complex</span>
            <span className="text-brand-accent">Chemistry</span>
          </h1>
          
          <p className="text-lg md:text-xl text-brand-gray-600 mb-8 md:mb-10 max-w-2xl mx-auto px-4">
            At Complex, we seek bold creative thinkers, generous collaborators and strive for approaches that
            look to make MEANING out of our time and resources. Our pre-interview assessments aim to bring together
            like minded people, who share the value of wanting to be generative in their outputs and win together.
          </p>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 max-w-lg mx-auto px-4">
            <Button 
              onClick={() => navigate("/assessments")} 
              size={isMobile ? "default" : "lg"} 
              className={`${isMobile ? 'h-12' : 'h-14 md:h-16'} text-lg hover-scale shadow-neumorphic hover:shadow-lg active:shadow-neumorphic-inset`}
            >
            ...
            <Button 
              ...
              size={isMobile ? "default" : "lg"} 
              variant="outline" 
              className={`${isMobile ? 'h-12' : 'h-14 md:h-16'} text-lg hover-scale border-brand-gray-300 text-brand-gray-700 hover:text-brand-gray-900`}
            >
        ...
        <div className="mt-12 md:mt-16 lg:mt-24 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 w-full max-w-6xl px-4">
          <div className="bg-white p-5 md:p-6 shadow-neumorphic hover:shadow-lg transition-shadow duration-300">
